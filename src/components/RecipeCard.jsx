...
const RecipeCard = ({meal}) => {
  return (
    ...
    {/* hover glow */}
      <div className='absolute inset-0 rounded-xl border-r border-transparent group-hover:border-blue-500 transition duration-500'>
      </div>

        <div className='flex justify-center items-center p-5'>
          <img src={meal.strMealThumb} alt="" className='h-60 w-60 rounded-xl border border-yellow-400 transition duration-500 group-hover:scale-[1.05]' />
        </div>
